...
- 감사 로그는 기본 365일 보존 후 gzip JSONL로 아카이브하고 삭제하며, 설정 화면에서 30~3650일·아카이브 사용 여부를 바꾸거나 즉시 정리할 수 있습니다.
- 대시보드는 backend 컨테이너 요청 로그를 이용해 최근 24시간 Manager API 404·5xx 추이와 오류 상위 경로를 표시합니다.
