...
| 운영 | Docker 컨테이너 자동 감지, Cloudflare DNS 설정 UI, 시간 표시 타임존 설정, 설정 백업/복원, 로그인 세션 관리, 업스트림 DNS strict mode/allowlist |
...
- 선택형 업스트림 DNS strict mode + allowlist 정책 (외부 FQDN suffix, Docker 서비스명, 사설 IPv4/Tailscale IP 제어)
