...
- [x] 보안 이벤트 외부 웹훅 알림
- [x] Slack/Discord/Telegram 보안 알림 preset
...
- [x] 보안 알림 provider preset (generic / slack / discord / telegram)
- [x] 선택형 Cloudflare Turnstile 로그인 보호
- [x] 로드맵/아키텍처/보안 문서 최신화

### 권장 실행 순서

1. Microsoft Teams / Email / PagerDuty 등 추가 알림 채널
2. Turnstile 모드 확장(항상 적용 / 위험 기반 적용)
3. passlib/bcrypt 관련 Python 3.13 전 경고 정리
