...
SMOKE_ADMIN_LAST_SUCCESS_AT_KEY = "dashboard_smoke_admin_last_success_at"
SMOKE_ADMIN_LAST_RUN_URL_KEY = "dashboard_smoke_admin_last_run_url"
...
async def read_smoke_run_status(repo: Any) -> dict[str, str | None]:
    return {
        ...
        "monitoring_admin_last_success_at": await repo.get(SMOKE_ADMIN_LAST_SUCCESS_AT_KEY),
        "monitoring_admin_last_run_url": await repo.get(SMOKE_ADMIN_LAST_RUN_URL_KEY),
...
async def record_smoke_run_success(
    ...
    *,
    ...
    if admin_checked:
        await repo.set(SMOKE_ADMIN_LAST_SUCCESS_AT_KEY, recorded_at)
        await repo.set(SMOKE_ADMIN_LAST_RUN_URL_KEY, run_url)
