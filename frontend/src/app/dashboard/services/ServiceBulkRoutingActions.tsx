...
export default function ServiceBulkRoutingActions({
  ...
  return (
    <section className="mb-4 flex flex-col gap-3 rounded-2xl border border-blue-200 bg-blue-50/70 p-3 dark:border-blue-500/30 dark:bg-blue-500/10 lg:flex-row lg:items-center lg:justify-between">
      <div>
