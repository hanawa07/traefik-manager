...
export function ManagerDeploymentCard({
  ...
  return (
    <div className="card mb-4 p-4 sm:mb-6 sm:p-5">
      ...
      <ManagerDeploymentStatusPanel
        consistencyMessage={componentConsistency.message}
        deployment={deployment}
        panelClassName={releaseTone.panel}
      ...
      <ManagerDeploymentHistory
        ...
        archiveSummary={deployment?.deployment_history_archive_summary}
