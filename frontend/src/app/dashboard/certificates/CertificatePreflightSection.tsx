...
export default function CertificatePreflightSection({
  ...
  return (
    <section className="rounded-2xl border border-gray-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
      <div className="mb-4">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-slate-100">사전 진단 결과</h3>
...
function PreflightLoading() {
  return (
    <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-5 dark:border-slate-700 dark:bg-slate-950">
...
function PreflightError({ error }: { error: unknown }) {
  return (
    <div className="rounded-xl border border-rose-200 bg-rose-50 px-4 py-4 dark:border-rose-500/50 dark:bg-rose-950/30">
      <p className="text-sm font-medium text-rose-700 dark:text-rose-200">사전 진단을 실행하지 못했습니다</p>
