...
export default function CertificateSummaryCards({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-5">
      <SummaryCard label="전체 인증서" value={totalCount} valueClassName="text-gray-900" />
      <SummaryCard label="발급 대기" value={pendingCount} valueClassName="text-blue-600" />
      <SummaryCard label="30일 이내 만료" value={warningCount} valueClassName="text-amber-600" />
      <SummaryCard label="만료됨" value={errorCount} valueClassName="text-red-600" />
      <SummaryCard
        label="최근 발급 실패"
