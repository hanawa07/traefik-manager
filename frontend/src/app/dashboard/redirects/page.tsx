...
export default function RedirectsPage() {
  ...
  return (
    <div className="p-8">
          ...
          <table className="w-full">
            <thead>
              <tr className="text-xs text-gray-400 border-b border-gray-100">
                ...
                <th className="px-6 py-3 text-left font-medium">작업</th>
              </tr>
            </thead>
      ...
      <Modal isOpen={isCreateOpen} onClose={() => setIsCreateOpen(false)} title="리다이렉트 추가">
      ...
      <Modal isOpen={!!editTarget} onClose={() => setEditTarget(null)} title="리다이렉트 수정">
        {editTarget && (
          <>
      ...
      <Modal isOpen={!!deleteTarget} onClose={() => setDeleteTarget(null)} title="리다이렉트 삭제">
