...
export function AuditLogPageHeader({ exportUrl }: { exportUrl: string }) {
  return (
    <div className="mb-8 flex flex-wrap items-center gap-3">
      ...
      <a
        className="ml-auto inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:border-blue-300 hover:text-blue-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:shadow-none dark:hover:border-blue-500 dark:hover:text-blue-200"
        href={exportUrl}
      >
