...
export const resourceTypeConfig: Record<string, ResourceTypeConfig> = {
  ...
  smoke_failure_metadata: { icon: Activity, label: "스모크 실패 정보", color: "border border-rose-200 bg-rose-50 text-rose-700" },
...
export const securityEventConfig: Record<string, BadgeConfig> = {
  ...
  smoke_failure_metadata_cleanup: { label: "스모크 실패 정보 정리", color: "bg-rose-50 text-rose-700 border-rose-200" },
  ...
  settings_test_smoke_admin_stale: { label: "관리자 지연 알림 dry-run", color: "bg-cyan-50 text-cyan-700 border-cyan-200" },
  settings_test_smoke_failure_type_increase: { label: "실패 유형 증가 알림 dry-run", color: "bg-cyan-50 text-cyan-700 border-cyan-200" },
