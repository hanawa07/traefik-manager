...
export function useMiddlewaresPageModel() {
  ...
  const derived = useMiddlewaresPageDerivedModel({
    ...
    templateSearch: uiState.templateSearch,
    templateStatusFilter: uiState.templateStatusFilter,
  ...
  return {
    ...
    sharedTab: {
      ...
      templateSearch: uiState.templateSearch,
      templateStatusFilter: uiState.templateStatusFilter,
      templatesCount: derived.sortedTemplates.length,
      visibleTemplates: derived.visibleTemplates,
      appliedServicesByTemplate: derived.appliedServicesByTemplate,
      runtimeMap: derived.runtimeMap,
      onTemplateSearchChange: uiState.setTemplateSearch,
      onTemplateStatusFilterChange: uiState.setTemplateStatusFilter,
      onCreateOpen: uiState.openCreate,
