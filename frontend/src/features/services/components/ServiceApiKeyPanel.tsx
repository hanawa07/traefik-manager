...
export default function ServiceApiKeyPanel({
  ...
  return (
    <div className="animate-in zoom-in-95 rounded-xl border border-purple-100 bg-purple-50 p-4 duration-200">
      ...
      <div
        className={
          ...
          "py-2 font-mono text-xs text-purple-900"
        }
      >
        {apiKeyValue}
      </div>
      <p className="mt-2 text-[10px] italic leading-relaxed text-purple-600">
