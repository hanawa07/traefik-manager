...
import { checkManagerDeploymentHistoryDetails } from "./dashboard-visual-manager-deployment-details.mjs";
import { checkManagerDeploymentPerformance } from "./dashboard-visual-manager-deployment-performance.mjs";
import { checkManagerDeploymentPeriodActions } from "./dashboard-visual-manager-deployment-period.mjs";
...
export async function checkManagerDeploymentHistoryActions({ cdp, timeoutMs }) {
  ...
  await checkManagerDeploymentPeriodActions({ cdp, timeoutMs });
  await checkManagerDeploymentHistoryDetails({ cdp, timeoutMs });
}
